...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.yoyo.controller..*.*(..))")//切入点描述 这个是controller包的切入点
    public void socialcontrollerLog(){}//签名，可以理解成这个切入点的一个名称

    @Pointcut("execution(public * com.yoyo.controller..*.*(..))")//切入点描述，这个是uiController包的切入点
